...
const CONTACTS = [
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/aditya-gupta-2725b5329',
    icon: (
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/a_.adityaa',
    icon: (
      <span style={{ display: 'inline-block', borderRadius: '50%' }}>
        <svg width="28" height="28" viewBox="0 0 448 448">
          <defs>
            <radialGradient id="ig" cx="30%" cy="107%" r="150%" fx="10%" fy="100%">
    ...
    <footer id="contact" className="footer">
      <div className="contact-wave-bg" aria-hidden="true">
        <svg viewBox="0 0 1440 320" width="100%" height="100" preserveAspectRatio="none">
          <path fill="#7c3aed" fillOpacity="0.18" d="M0,160L60,170.7C120,181,240,203,360,197.3C480,192,600,160,720,133.3C840,107,960,85,1080,101.3C1200,117,1320,171,1380,197.3L1440,224L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z" />
        </svg>
      </div>

      <h2 className="sub-title">Contact <span>Me</span></h2>
      <p className="footer-note">Let's work together! Feel free to reach out 👇</p>
      ...
      <div className="contact-details">
        <div className="contact-list">
          <strong>Email:</strong> <a href="mailto:adigupta2121@gmail.com">adigupta2121@gmail.com</a>
        </div>
      </div>

      <p className="footer-note copyright">&copy; {new Date().getFullYear()} Developed by Aditya Gupta. All rights reserved.</p>
    </footer>
  )
}
